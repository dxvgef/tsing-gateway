...
func easyjsonA8649303DecodeLocalDiscoverTsingCenter(in *jlexer.Lexer, out *TsingCenter) {
...
func easyjsonA8649303EncodeLocalDiscoverTsingCenter(out *jwriter.Writer, in TsingCenter) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v TsingCenter) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonA8649303EncodeLocalDiscoverTsingCenter(&w, v)
...
func (v *TsingCenter) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonA8649303DecodeLocalDiscoverTsingCenter(l, v)
}
