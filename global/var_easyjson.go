...
func easyjson4b82ef5DecodeGithubComDxvgefTsingGatewayGlobal(in *jlexer.Lexer, out *UpstreamType) {
...
func easyjson4b82ef5EncodeGithubComDxvgefTsingGatewayGlobal(out *jwriter.Writer, in UpstreamType) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v UpstreamType) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson4b82ef5EncodeGithubComDxvgefTsingGatewayGlobal(&w, v)
...
func (v *UpstreamType) UnmarshalJSON(data []byte) error {
	...
	easyjson4b82ef5DecodeGithubComDxvgefTsingGatewayGlobal(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *UpstreamType) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson4b82ef5DecodeGithubComDxvgefTsingGatewayGlobal(l, v)
}
func easyjson4b82ef5DecodeGithubComDxvgefTsingGatewayGlobal1(in *jlexer.Lexer, out *ModuleConfig) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson4b82ef5EncodeGithubComDxvgefTsingGatewayGlobal1(out *jwriter.Writer, in ModuleConfig) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v ModuleConfig) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson4b82ef5EncodeGithubComDxvgefTsingGatewayGlobal1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *ModuleConfig) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson4b82ef5DecodeGithubComDxvgefTsingGatewayGlobal1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *ModuleConfig) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson4b82ef5DecodeGithubComDxvgefTsingGatewayGlobal1(l, v)
}
func easyjson4b82ef5DecodeGithubComDxvgefTsingGatewayGlobal2(in *jlexer.Lexer, out *EndpointType) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson4b82ef5EncodeGithubComDxvgefTsingGatewayGlobal2(out *jwriter.Writer, in EndpointType) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v EndpointType) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson4b82ef5EncodeGithubComDxvgefTsingGatewayGlobal2(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *EndpointType) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson4b82ef5DecodeGithubComDxvgefTsingGatewayGlobal2(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *EndpointType) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson4b82ef5DecodeGithubComDxvgefTsingGatewayGlobal2(l, v)
}
